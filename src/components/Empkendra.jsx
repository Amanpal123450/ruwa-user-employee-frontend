...
//   console.alert( "Application submitted successfully!");
    ...
    if (validate()) {
      ...
      try {
        ...
        if (res.ok) {
          ...
          window.open("https://razorpay.me/@nhsindia?amount=gtjkDOGv69g55ggcfywxBg%3D%3D", "_blank");
        ...
        <div className="container-fluid py-4">
          <div className="row">
            <div className="col-12">
                  ...
                  <div className="row align-items-center">
                    <div className="col-lg-8 col-md-7">
                      <div className="welcome-content">
                        ...
                        <p className="welcome-subtitle">
                          {showPaymentForm 
                            ? "Complete your payment to finalize application"
              ...
              {/* Franchise Info Cards - Only show when not in payment mode */}
              {!showPaymentForm && (
                <div className="row mb-5">
                  {franchiseInfo.map((info, index) => (
                    <div className="col-12 col-md-6 col-lg-3 mb-4" key={index}>
